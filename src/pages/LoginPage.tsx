                ...
                <div className="space-y-4 py-1">
                  ...
                  <div className="flex items-start gap-4 group">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] text-slate-400 mt-0.5">Instant WhatsApp chat &amp; voice support</p>
                    </div>
                  </div>

                  {/* Instagram */}
                  <div className="flex items-start gap-4 group">
                    <div className="w-10 h-10 rounded-xl bg-pink-500/10 border border-pink-500/20 text-pink-400 flex items-center justify-center shrink-0 mt-0.5 group-hover:scale-105 group-hover:bg-pink-500/20 transition-all">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm font-semibold text-white hover:text-pink-400 transition-colors block"
                      >
                        @fx_journalpro
                      </a>
